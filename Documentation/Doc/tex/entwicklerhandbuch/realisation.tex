\chapter{Realisation}
    ...
    \section{Arithmetic logic unit (ALU)}
        ...
        \subsection{Rechenwerk Multiplexer}
            ...
            \lstinputlisting[style=vhdl,linerange={26-37},caption={Prozess des linken rechtenwerk Multuiplexers}]{../../CPU/Design/src/alu/mux_alu_left.vhd}
            \lstinputlisting[style=vhdl,linerange={27-38},caption={Prozess des rechten rechtenwerk Multuiplexers}]{../../CPU/Design/src/alu/mux_alu_right.vhd}
    ...
    \section{IO}
        ...
        \lstinputlisting[style=VHDL,caption={Schreiprozess für die Peripherie},linerange={50-63},label=lst:peripherie-write]{../../CPU/Design/src/io/peripherie.vhd}
