...
def to_fpga_memory():
    ...
    cnt = 0
    for i in ordered_binary:
        print('0x{:04x}'.format(cnt) + ': ' + ''.join(['{:08b}'.format(int(j, 16)) for j in [i[3], i[2], i[1], i[0]]]))
        cnt += 4
...
if __name__ == "__main__":
    ...
    #os.system(TOOLPATH + 'riscv64-unknown-elf-gcc.exe -ffunction-sections -nostdlib -march=rv32i -mabi=ilp32 -O1 -T linker.lds ' + FILE + ' -o ' + OUTPUTFILE)
